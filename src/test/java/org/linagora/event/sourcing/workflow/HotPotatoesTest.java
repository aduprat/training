...
//		Board board = new Board("myBoard");
		// First task 1 event
//		CreateCommand createCommand = new CreateCommand("name");
...
//		CreateCommand createCommand2 = new CreateCommand("name2");
...
//		hotPotatoe.apply(createTask2.get());
		...
		assertThat(tasks).hasSize(2)
			.containsExactly(new TaskVO(task2.getId(), null, 2, null),
					new TaskVO(task.getId(), null, 1, user.getName()));
	}
}
