...
import org.linagora.event.sourcing.EventSystem;
...
public class HotPotatoesTest {
	...
	@Test
	public void getTasksShouldBeIdempotent() {
		HotPotatoe hotPotatoe = new HotPotatoe();
